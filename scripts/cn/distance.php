...
case when description is NULL then (select translate from db_gopark.tb_translate where sign = 'No Restrictions') else e.translate end as sign, 
...
sqrt(power(($lat-lat),2)+power(($long-lon),2)) as euclid,
current_status, present/total as unoccupied_rate,
...
left join tb_translate e on b.TypeDesc = e.sign
where 
